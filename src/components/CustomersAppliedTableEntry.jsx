...
export default function CustomersAppliedTableEntry() {
  return (
    <div className="main__content__table__list">
      ...
      <div className="main__content__table__list__entry">Bank Alflah</div>
      <div className="main__content__table__list__entry">33105-202324434-9</div>
      <div className="main__content__table__list__entry">300000</div>
    </div>
  );
}
